...
public class Es3SpecSoapTest extends BaseFunctionalTestCase {
	...
	public void testFindEs3Spec() {
		...
		DTOResult<Es3SpecDTO> responseParams = cmdbuildSoapService.findEs3SpecByParams(searchParams);

		assertEquals(code, responseParams.getDto().getCode());

		id = responseParams.getDto().getId();// 设置id

		DTOResult<Es3SpecDTO> response = cmdbuildSoapService.findEs3Spec(id);
	...
	public void testGetEs3SpecList() {
		...
		DTOListResult<Es3SpecDTO> result = cmdbuildSoapService.getEs3SpecList(searchParams);
	...
	public void testCreateEs3Spec() {
		...
		IdResult response = cmdbuildSoapService.createEs3Spec(es3SpecDTO);
	...
	public void testUpdateEs3Spec() {
		...
		IdResult result = cmdbuildSoapService.updateEs3Spec(id, es3SpecDTO);
	...
	public void testDeleteEs3Spec() {
		...
		IdResult response = cmdbuildSoapService.deleteEs3Spec(id);
	...
	public void testGetEs3SpecPagination() {
		...
		PaginationResult<Es3SpecDTO> result = cmdbuildSoapService.getEs3SpecPagination(searchParams, 1, 10);
