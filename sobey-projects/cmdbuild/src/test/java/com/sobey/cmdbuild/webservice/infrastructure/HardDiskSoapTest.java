...
public class HardDiskSoapTest extends BaseFunctionalTestCase {
	...
	public void find() {
		...
		DTOResult<HardDiskDTO> dtoResult = cmdbuildSoapService.findHardDiskByParams(searchParams);
	...
	public void save() {
		...
		IdResult response = cmdbuildSoapService.createHardDisk(dto);
	...
	public void update() {
		...
		HardDiskDTO dto = response.getDto();
		dto.setDescription(dto.getDescription() + "Update");
		IdResult result = cmdbuildSoapService.updateHardDisk(id, dto);
