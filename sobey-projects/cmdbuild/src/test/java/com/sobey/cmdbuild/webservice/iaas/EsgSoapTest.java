...
public class EsgSoapTest extends BaseFunctionalTestCase {
	...
	public void find() {
		...
		DTOResult<EsgDTO> dtoResult = cmdbuildSoapService.findEsgByParams(searchParams);
	...
	public void save() {
		...
		IdResult response = cmdbuildSoapService.createEsg(dto);
	...
	public void update() {
		...
		EsgDTO dto = response.getDto();
		dto.setDescription(dto.getDescription() + "Update");
		IdResult result = cmdbuildSoapService.updateEsg(id, dto);
