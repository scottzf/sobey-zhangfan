...
/**
 * <p>
 * deleteEIPByFirewallResponse complex type的 Java 类。
 * 
 * <p>
 * 以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="deleteEIPByFirewallResponse">
 *   &lt;complexContent>
...
@XmlType(name = "deleteEIPByFirewallResponse", propOrder = { "_return" })
public class DeleteEIPByFirewallResponse {
