...
/**
 * <p>getGroups complex type的 Java 类。
 * 
 ...
 *         &lt;element name="grpIds" type="{http://www.w3.org/2001/XMLSchema}unsignedLong" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetGroups {
    ...
    protected List<BigInteger> grpIds;
    ...
    /**
     * Gets the value of the grpIds property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the grpIds property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGrpIds().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BigInteger> getGrpIds() {
        if (grpIds == null) {
            grpIds = new ArrayList<BigInteger>();
        }
        return this.grpIds;
    }
