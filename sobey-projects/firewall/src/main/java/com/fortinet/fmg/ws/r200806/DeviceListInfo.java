...
/**
 * <p>deviceListInfo complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="deviceListInfo">
 *   &lt;complexContent>
 ...
 *         &lt;element name="history" type="{http://r200806.ws.fmg.fortinet.com/}historyInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "deviceListInfo", propOrder = {
    "devName",
    "ip",
    "status",
    "message",
...
public class DeviceListInfo {
    ...
    protected List<HistoryInfo> history;
