...
/**
 * <p>getTaskListResponse complex type的 Java 类。
 * 
 ...
 *         &lt;element name="taskList" type="{http://r200806.ws.fmg.fortinet.com/}taskListInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetTaskListResponse {
    ...
    protected List<TaskListInfo> taskList;
    ...
    public List<TaskListInfo> getTaskList() {
        if (taskList == null) {
            taskList = new ArrayList<TaskListInfo>();
        }
